...
import { FiArrowLeft, FiUser, FiUsers, FiHeart, FiCalendar, FiMapPin, FiBriefcase, FiCheck, FiAlertCircle } from 'react-icons/fi';
...
export default function ThanhVienCreatePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || err.response?.data?.error || 'Lỗi thêm thành viên');
    } finally {
      setIsLoading(false);
    }
  };
