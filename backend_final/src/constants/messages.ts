export const USERS_MESSAGES = {
  ...
  // Messages cho đăng ký với gia phả exist=true
  MEMBER_ALREADY_HAS_ACCOUNT: 'Thành viên này đã có tài khoản',
  MULTIPLE_MEMBERS_FOUND: 'Có nhiều thành viên cùng tên trong gia phả. Vui lòng chọn đúng người.',
  MEMBER_NOT_IN_GIAPHA: 'Không tìm thấy thành viên trong gia phả',
  LINKED_EXISTING_MEMBER: 'Liên kết với thành viên đã có trong gia phả',
  CREATED_NEW_MEMBER: 'Đã tạo thành viên mới trong gia phả',
  SELECT_MEMBER_REQUIRED: 'Vui lòng chọn thành viên từ danh sách',
...
export const PHIEUCHI_MESSAGES = {
  CREATE_SUCCESS: 'Tạo phiếu chi thành công',
  CREATE_FAILED: 'Tạo phiếu chi thất bại',
  GET_SUCCESS: 'Lấy dữ liệu thành công',
  GET_LIST_SUCCESS: 'Lấy danh sách phiếu chi thành công',
  NOT_FOUND: 'Không tìm thấy phiếu chi',
  DELETE_SUCCESS: 'Xóa phiếu chi thành công',
  DELETE_FAILED: 'Xóa phiếu chi thất bại',
  UPDATE_SUCCESS: 'Cập nhật phiếu chi thành công',
  UPDATE_FAILED: 'Cập nhật phiếu chi thất bại',
  FORBIDDEN: 'Bạn không có quyền thực hiện hành động này',
  NOT_CATEGORY_MANAGER: 'Bạn không có quyền lập phiếu chi cho danh mục này. Chỉ người đảm nhận danh mục mới được phép.',
